  ...
  return (
    <div className='w-full'>
      <div className='container-x mx-auto'>
        <div className='best-services rounded w-full bg-black flex flex-col space-y-10 lg:space-y-0 lg:flex-row lg:justify-between lg:items-center lg:h-[110px] h-full px-10 lg:py-0 py-10'>
