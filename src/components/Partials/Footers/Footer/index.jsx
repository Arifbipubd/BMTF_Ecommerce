...
export default function Footer({ settings, contact }) {
  ...
  return (
    <footer
      ...
      className='footer-section-wrapper bg-white print:hidden pl-3.5 sm:pl-0 relative mt-8'
    >
              ...
              <div>
                <div className='flex flex-col space-y-5 '>
                  ...
                  <p className=' text-white pr-5 '>
                    ...
                    to the national economy and industrial growth. <br /> <br />{" "}
                    Trade License no: 5/12 <br /> Tin: 876812939905
                  </p>
                </div>
              </div>
              {/* )} */}
